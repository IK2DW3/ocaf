            ...
            <div class="row w-100">
                <div class="col-sm-12">
                    ...
                    <div id="tablero">
                        ...
                        <div class="casilla casillaJuego px-2 py-2 text-center" :id="'casilla'+(n=n+1)" v-for="n in 61" :key="n">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 casillaFooter">
                                    <p class="m-0" :id="'nombreMujer'+n" v-if="n!==5 && n!==6 && n!==9 && n!==12 && n!==14 && n!==18 && n!==19 && n!==23 && n!==27 && n!==31 && n!==32 
                                        && n!==35 && n!==41 && n!==42 && n!==45 && n!==50 && n!==52 && n!==54 && n!==58 && n!==59" v-text="''"></p>
                                </div>
                            </div>
                        </div>
