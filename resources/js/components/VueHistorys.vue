    ...
    <div class="row px-4 py-2">
        <div class="col-sm-12">
            <div class="row bg-dark m-0 px-1 py-3 rounded">
                ...
                <div class="col-sm-12 my-2">
                       <input class="form-control" type="search" v-model="busqueda" name="buscador" placeholder="Buscar en página"
                        autocomplete="off">
                </div>
            </div>
        </div>
        <div v-for="carta in buscarCarta" v-bind:key="carta.id" class="col-sm-12 col-md-4 col-lg-3 col-xl-2">
