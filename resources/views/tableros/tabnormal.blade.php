...
<!-- el tablero esta formado de 63 casillas que dependeiendo de su tipo tendran o no : un boton de pregunta, un numero y un area donde se guardan las fichas de juego si se cae en dicha casilla-->
    <div id ="tablero">
            <div class="casilla" id= "casillaInicio"><p class="Nº">1</p><button class="pregunta">?</button><div class="area" id="area1"></div></div>
            ...
            <div class="casilla" id= "casillaFinal"><p class="Nº">63</p><button class="pregunta">?</button><div class="area" id="area63"></div></div>
    </div>
<!-- los jugadores -->
